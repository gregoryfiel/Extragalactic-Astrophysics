...
def main():
    ...
    # Normalização e configuração de erro
    norm_count = True
    error_ex = np.ones_like(flux_ex)
    
    # Configuração da linha espectral
    l0_line = 6562
    ...
    analyzer.run_analysis()  # Certifique-se de que `fit_cont` não é chamado aqui
